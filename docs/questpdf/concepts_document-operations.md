...
> **INFO:** Features presented in this sections are created using the [qpdf](https://github.com/qpdf/qpdf) library, available under the "Apache-2.0" license. We extend our thanks to the authors of qpdf for their contributions to the open-source community. The code of qpdf library has been extended by QuestPDF to support important PDF/A-3b compliance requirements as well ZUGFeRD metadata extension.

> **WARNING:** Features presented in this section are available starting from the 2024.12.0 version of the library.
...
> **WARNING:** Please ensure that the document is PDF/A-3b compliant before extending its metadata.
