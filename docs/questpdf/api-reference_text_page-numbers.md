# API Reference: Text Page Numbers
...
> **TIP:** [Section](/api-reference/section.html) defines part of the document that can be further referenced by name, e.g. for page numbering or linking.

#### Available methods

| Method | Description |
| --- | --- |
| BeginPageNumberOfSection | Appends text showing the number of the first page of the specified . |
| EndPageNumberOfSection | Appends text showing the number of the last page of the specified . |
| PageNumberWithinSection | Appends text showing the page number relative to the beginning of the given . For a section spanning pages 20 to 50, page 35 will show as 15. |
| TotalPagesWithinSection | Appends text showing the total number of pages within the given . For a section spanning pages 20 to 50, the total is 30 pages. |
