...
> **INFO:** If you encounter this exception, it could indicate a bug in the QuestPDF library. Please reach out to our support team with the error details, and we’ll work to resolve it promptly.

> **WARNING:** If you are using [Dynamic Components](/concepts/code-patterns/dynamic-components.html), all exceptions thrown there are going to bubble up as this type of exception. In such case, please review the implementation of your dynamic components.
