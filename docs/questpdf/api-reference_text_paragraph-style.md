# API Reference: Text Paragraph Style
...
| AlignStart | Aligns the text horizontally to the start of the container.  This method sets the horizontal alignment of the text to the start (left for left-to-right languages, right for right-to-left languages). |
| AlignEnd | Aligns the text horizontally to the end of the container.  This method sets the horizontal alignment of the text to the end (right for left-to-right languages, left for right-to-left languages). |
