...
import { FileText, Move, Maximize2, Settings2, Paintbrush, Eye, Expand } from 'lucide-react';
...
export function SelectedComponentPanel({ component }: { component: Component }) {
  ...
  return (
    <div className="py-4">
      ...
      {/* Layout Section (Auto-expand) */}
      <Section title="Layout" icon={<Expand className="h-4 w-4" />} defaultOpen={false}>
        <LayoutSettings component={component} />
      </Section>
